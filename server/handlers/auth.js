constdb = require('../models/mongo_index');//before anything we will be needing our database
...
module.exports.register = async(req,res,next) =>{ //async db , async always uses try catch //this way we will not need to do promises and callbacks
try{
